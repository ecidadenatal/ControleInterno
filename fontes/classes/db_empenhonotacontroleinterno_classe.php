...
class cl_empenhonotacontroleinterno extends DAOBasica {
  ...
  function sql_query_empenhos_para_controle_interno ($sCampos = '*', $sOrder, $sWhere) {
    ...
    $sSqlEmpenhos .= "       inner join orcdotacao   on e60_coddot  = o58_coddot" ;
    $sSqlEmpenhos .= "                              and e60_anousu  = o58_anousu";
  ...
  function sql_query_documento_analise($sCampos = '*', $sOrder = '', $sWhere = '') {
    ...
    $sSql .= " inner join plugins.empenhonotacontroleinternohistorico on empenhonotacontroleinterno.sequencial = empenhonotacontroleinterno ";
