...
where analise.sequencial = $iInstrucaoTecnica ";
  ...
  private function escreverRodape($oDados) {
    ...
    $this->html .= "<div style='position:absolute;top:80;left:378'><span class='ft0'>DESPACHO</span></div>";
    $this->html .= "<div style='position:absolute;top:98;left:80'><p class='ft5'>De acordo com a informação acima, encaminhamos o processo ao órgão de origem para providências.</p></div>";
    $this->html .= "<div style='position:absolute;top:150;left:325'><span class='ft8'>{$sCidade}, {$oDataAnalise->dataPorExtenso()}</span></div>";    
    if ($oDados->nome_diretor_atual != "") {
      $this->html .= "<div style='position:absolute;top:230;left:492'><span class='ft8'>__________________________________________</span></div>";
      $this->html .= "<div style='position:absolute;top:250;left:557'><span class='ft8'>{$oDados->nome_diretor_atual}</span></div>";
      $this->html .= "<div style='position:absolute;top:276;left:569'><span class='ft8'>{$oDados->cargo_diretor_atual}</span></div>";
    }
    $this->html .= "</div>";
    //div fim
    //$this->html .= "</div>";
